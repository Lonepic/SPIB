...
You can download pre-trained models and sample point clouds [HERE](https://drive.google.com/file/d/1mVA9R-KzwWdFRnir0_ZUI7PiCcMlTKKg/view?usp=sharing). Unzip the file under the project root path (`/path/to/project/checkpoint_dir`) and then run:

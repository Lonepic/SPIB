...
def get_iou_obb_seg(ins1,ins2):

    intersect = ins1.astype(int) & ins2.astype(int)
    union = ins1.astype(int) | ins2.astype(int)
    iou = float(np.sum(intersect)) / (np.sum(union) + 1e-8)
